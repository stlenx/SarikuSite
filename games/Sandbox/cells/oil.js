    ...
    Update() {
        if(world[this.x][this.y+1].type === type.empty && newWorld[this.x][this.y+1].type === type.empty) {
            ...
            if(Math.floor(getRandom(0,2)) === 0) {
                if(world[this.x - 1][this.y + 1].type === type.empty && newWorld[this.x - 1][this.y + 1].type === type.empty) {
                    ...
                    if(Math.floor(getRandom(0,2)) === 0) {
                        if(world[this.x + 1][this.y].type === type.empty && newWorld[this.x+1][this.y].type === type.empty) {
